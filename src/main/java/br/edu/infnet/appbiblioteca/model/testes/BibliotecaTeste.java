...
public class BibliotecaTeste {
    public static void main(String[] args) {
        ...
        Anime anime = new Anime("Shigofumi", "Slice of Life", false, 9);
        try {
        ...
        Manga manga = new Manga("getsuyoubi no tomodachi", "Slice of Life/ Ficção", false, 8);
        try {
        ...
        Jogo jogo = new Jogo("Shantae", "Aventura/Plataforma", false, 9);
        try {
