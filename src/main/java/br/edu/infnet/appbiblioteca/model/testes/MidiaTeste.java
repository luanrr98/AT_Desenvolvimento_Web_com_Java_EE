...
public class MidiaTeste {
    ...
    public static void main(String[] args) {
        try {
            Jogo jogo = new Jogo("Castlevania", "MetroidVania", false, 8);
        ...
        try {
            Jogo jogo2 = new Jogo("Bloodstained", "ClassicVania", false, 8);
        ...
        try {
            Anime anime = new Anime("Naruto", "Ação", true, 9);
        ...
        //Errando para Mostrar Excessão
        try {
            Anime anime2 = new Anime("91 Days", "Ação", false, 7);
        ...
        //Errando para Mostrar Excessão
        try {
            Anime anime3 = new Anime("Mayoiga", "Suspense", false, 4);
        ...
        try {
            Anime anime4 = new Anime("Boruto", "Aventura", false, 8);
        ...
        try {
            Manga manga = new Manga("The Witcher", "Ação/Medieval", true, 9);
        ...
        //Errando para Mostrar Excessão
        try {
            Manga manga2 = new Manga("Dragon Ball", "Aventura/Ação", false, 9);
